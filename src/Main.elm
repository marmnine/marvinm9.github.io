...
update msg model =
    case msg of
        StartDownload ->
            ( model, FileDownload.url "https://marvinm9.github.io/audio27.mp3" )
...
pageContent =
    ...
    column
        ...
        , el [ centerX, color <| rgb255 234 175 65, size eve, onRight <| el [ color <| rgb255 234 175 65, size eve ] (text ".") ] <| text "27"
